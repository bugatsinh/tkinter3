...
def getwell():
    ...
    print(f"{namevalue.get(),phonevalue.get(),gendervalue.get(),Emergensyvalue.get(),payment_Modevalue.get(),foodscrvesvalue.get()}")
    with open("record.txt","a")as f:
        f.write(f"{namevalue.get(),phonevalue.get(),gendervalue.get(),Emergensyvalue.get(),payment_Modevalue.get(),foodscrvesvalue.get()}\n")
...
foodscrves = Checkbutton(
    text="want to pry book your meals", variable=foodscrvesvalue)
